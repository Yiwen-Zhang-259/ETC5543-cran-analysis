...
In this section, we studied the daily downloads of R language itself from `r dd_start` to `r dd_end`. The data is obtained from the `cranlogs` package [@cranlogs] as well.
