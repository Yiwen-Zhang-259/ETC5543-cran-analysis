...
In this section, we compare last half year's total downloads with the number of commits on master branch in Github repositories. And this turn, we initially planned to replace the research object with all the packages on CRAN with 17674 packages up to 2021-06-06. But we soon found out that there are only 6185 packages that have a Github repository, and after cleaning up, only 5610 remained.
