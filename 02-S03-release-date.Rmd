...
- b) Bayesian packages for general model fitting
...
taskview_downloads %>% 
  ...
  labs(x = "Initial release date",
       y = "Download counts",
       title = "Initial release date VS total download count",
       subtitle = "for Time Series Analysis, Bayesian and Econometrics packages") +
