...
pkg_trending_filter <- pkg_trending_46 %>%
...
commits <- c(get_commits("rtdists","fddm"),get_commits("r-lib","webfakes"),get_commits("nalzok","tree.interpreter"),get_commits("harryprince","geospark"),get_commits("cloudyr","AzureStor"),get_commits("spatstat","spatstat.core"),get_commits("Azure","AzureRMR"),get_commits("baddstats","spatstat.linnet"),get_commits("cran","clickstream"),get_commits("jeroen","js"),get_commits("spatstat","spatstat.sparse"),get_commits("ltorgo","DMwR2"),get_commits("daroczig","botor"),get_commits("timelyportfolio","sunburstR"),get_commits("jacob-long","panelr"),get_commits("markmfredrickson","RItools"),get_commits("rlib","textshaping"),get_commits("rlib","ragg"),get_commits("DyfanJones","RAthena"),get_commits("jeroen","V8"),get_commits("timelyportfolio","d3r"),get_commits("daroczig","logger"),get_commits("dreamRs","fresh"),get_commits("nir0s","distro"),get_commits("h2oai","rsparkling"),get_commits("christophergandrud","DataCombine"),get_commits("quanteda","quanteda.textmodels"),get_commits("rstudio","bslib"),get_commits("rstudio","jquerylib"),get_commits("mclements","rstpm2"))

get_commits("markmfredrickson","RItools")
get_commits("rlib","textshaping")
get_commits("rlib","ragg")
get_commits("DyfanJones","RAthena")
get_commits("jeroen","V8")
get_commits("timelyportfolio","d3r")
get_commits("daroczig","logger")
get_commits("dreamRs","fresh")
get_commits("nir0s","distro")
get_commits("h2oai","rsparkling")
get_commits("christophergandrud","DataCombine")
get_commits("quanteda","quanteda.textmodels")
get_commits("rstudio","bslib")
get_commits("rstudio","jquerylib")
get_commits("mclements","rstpm2")
...
```{r commits-tbl}
trending_downloads %>%
  kable(caption = "Top 15 scored trending packages with commits on Github and last half year's downloads") %>%
  kable_styling(bootstrap_options = c("hover", "striped")) 
```
...
trending_downloads %>%
  ...
  labs( y = 'Total download count',
    ...
    subtitle = "of top 50 trending packages for last half year") +
    annotate("text",y= 28000,x= 150,label="'fddm' with the most commits has 0 downloads for last half year",color="red") +
  theme_minimal()  +
  theme(panel.grid.major = element_blank()) +
  theme(
  axis.text=element_text(size=10),
