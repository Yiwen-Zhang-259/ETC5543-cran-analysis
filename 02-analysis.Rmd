...
fable <- cran_downloads(package = "fable", from = date3, to = date4) # to get the weighed 7-MA later, set the start day on Saturday

forecast <- cran_downloads(package = "forecast", from = date3, to = date4) 
