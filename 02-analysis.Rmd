...
Table \@ref(tab:pct-lngname) shows the 95% confidence interval of name length for trending packages. We could know that the most suitable name length is between 7 and 9 characters.
