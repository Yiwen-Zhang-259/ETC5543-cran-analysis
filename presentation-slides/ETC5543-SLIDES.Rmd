...
### .grey[CRAN task view packages]

--

### Packages that are .orange[initially] released .orange[earlier] on CRAN tend to have a .orange[higher] download count in the past year.
...
### .grey[All available CRAN packages with Github repo]
...
## .grey[All available CRAN packages]
...
---
class: hide-logo
### `r emo::ji("thinking")`Over half of the packages tend to have *.orange[shorter]* names
...
### `r emo::ji("thinking")` The difference in downloads for each alphabetical groups varies **.red[little]**
...
---
# `r emo::ji("star")`Conclusion

--

### .grey[Many factors do affect download cout of R packages on CRAN]
